...
import { ProgramSemesterDashboard } from "../../features/teacher/dashobard/utils";
      ...
      >
        {[0, 1, 2].map((i) => (
          ...
          >
            ...
            {i < 2 && (
              <div style={{ width: 1, height: 28, background: "#ede9e1" }} />
            )}
          </div>
        ))}
      </div>
          ...
          {loading ? (
            ...
            <>
              ...
              >
                ...
                />
                each{" "}
                <strong style={{ color: "#1e1c19", margin: "0 3px" }}>
                  ring
                </strong>{" "}
                = 1 subject
              </div>
